...
$from=$_POST['from'];
$to=$_POST['to'];
$depart_date=$_POST['date_depart'];
$no_ofp=$_POST['nop'];
$plane=$_POST['plane_name'];

?>


<form id="form" name="form" action="save.php" method="post"  onsubmit="return validateForm()">
<input type="hidden" name="h1" value="<? echo $trip;?>"/>
<input type="hidden" name="h2" value="<? echo $from;?>"/>
<input type="hidden" name="h3" value="<? echo $to;?>"/>
<input type="hidden" name="h4" value="<? echo $depart_date;?>"/>
<input type="hidden" name="h5" value="<? echo $no_ofp;?>"/>
<input type="hidden" name="h6" value="<? echo $plane;?>"/>
<input type="text" name="setnum" value="<?php $N = $qty;for($i=0; $i < $N; $i++)
{
echo $i+$setnum.', ';
} 
 ?>
