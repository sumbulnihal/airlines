...
$qty=$_POST['nop'];
$rout2=$_POST['to'];
$plane_n=$_POST['plane_name'];
$rot_type=$_POST['trip'];
$date_arive=$_POST['date_arive'];
...
<?php
if ($avail < $qty){
echo "<script>alert('NO More Seats Are Available in this Flight!');
...
<input type="hidden" value="<?php echo $rout2; ?>" name="routto" />
<input type="hidden" value="<?php echo $rot_type; ?>" name="type_r" />
<input type="hidden" value="<?php echo $plane_n; ?>" name="planes_nam" />
<input type="hidden" value="<?php echo $date_arive; ?>" name="date_arived" />
<label>Seat Number
